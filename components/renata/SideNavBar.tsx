...
export function SideNavBar() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen z-50 shrink-0 flex-col bg-sys-surface/80 backdrop-blur-2xl border-r border-sys-border shadow-sm w-60 hidden lg:flex">
      {/* Branding */}
            ...
            return (
              <li key={chapter.slug}>
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-xl font-geist font-bold text-sm transition-all duration-200 cursor-pointer active:scale-[0.98] px-3 py-2.5 ${isActive ? 'bg-sys-primary-container/20 text-sys-primary shadow-sm' : 'text-sys-muted hover:text-sys-text hover:bg-sys-bg'}`}
          ...
          <ul className="flex flex-col gap-1 mt-4">
            ...
            <li>
              <Link
                ...
                className={`flex items-center gap-3 rounded-xl font-geist font-bold text-sm transition-all duration-200 cursor-pointer px-3 py-2.5 ${pathname.startsWith('/renata/insights') ? 'bg-sys-primary-container/20 text-sys-primary shadow-sm' : 'text-sys-faint hover:text-sys-text hover:bg-sys-bg'}`}
              >
