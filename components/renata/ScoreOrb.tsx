  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="relative w-44 h-44 flex items-center justify-center animate-score-orb-pulse">
        ...
        {/* Score number */}
        <span className="font-sans font-semibold text-4xl text-sys-primary relative z-10">
          {clampedScore}
        </span>
      </div>

      {/* Label */}
      <span className="font-mono text-sm text-sys-muted uppercase tracking-wider">
        {label}
      </span>
    </div>
  );
